...
const Home = () => {
    ...
    <div className="w-full min-h-screen">
      ...
      >
        <header className="w-[100%] flex justify-between items-center">
          ...
          <RxCross2
            className="w-[30px] h-[30px] cursor-pointer hover:text-gray-600"
  ...
  <button className="w-[80%] mt-5 p-3 bg-orange-500 rounded-lg text-white hover:bg-orange-400 transition-all flex justify-center item mx-auto">Place Order</button>
</div>
      </div>
    </div>
  );
